...
$query1 = "SELECT * FROM request WHERE repair_status != 'pending' and total_bill = '-'";
            ...
            while ($row = mysqli_fetch_assoc($result1)): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="admin_addbill.php?id=<?php echo $row['id']; ?>">
                            <button class="btn btn-primary mt-2" <?php echo ($row['repair_status'] == 'Work Done') ? '' : 'disabled'; ?>>Add Bill</button>
                        </a>
