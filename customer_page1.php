...
<div  style="display: block;margin-top: 7%;"><ul>
        
        <a href="make_request.html"><button style="height:150px;width: 250px; border-radius: 10%;margin-right: 10px;background-color: white;"><img src="img/add.png" style="width: 20px;height:15px;"><br> Make Request</button></a>
        <a href="request made.php"><button style="height:150px;width: 250px; border-radius: 10%;margin-right: 10px;background-color: white;"><img src="img/crt.png" style="width: 20px;height:15px;"><br>View Status</button></a>
        <a href="customer_viewreq.php"><button style="height:150px;width: 250px; border-radius: 10%;margin-right: 10px;background-color: white;"><img src="img/feed.png" style="width: 20px;height:15px;"><br>Request Status</button>
        <a href="customer_viewbill.php"><button style="height:150px;width: 250px; border-radius: 10%;margin-right: 10px;background-color: white;"><img src="img/rupee.png" style="width: 20px;height:15px;"><br>Bill Amount</button>
      </ul>
      </div>
