...
$query = "SELECT * FROM request WHERE repair_status!='Pending'";
...
<head>
    ...
    <title>Admin-MechanicWork Status</title>
...
<div class="container">
    ...
    <table class="table table-bordered table-custom">
                            ...
                            ?>
                            <tr>
                                <td><?php echo ucwords($row["customer_email"]); ?></td>
                                <td><?php echo ucwords($row['problem_description']); ?></td>
                                <td><?php echo ucwords($row['mechanic_assign']); ?></td>
                                <td><?php echo ucwords($row['assigned_date']); ?></td>
                                <td><?php echo ucwords($row['expected_delivery']); ?></td>
                                <td><?php echo ucwords($row['repair_status']); ?></td>
                                <td><?php echo ucwords($row['bill_amount']); ?></td>
                            </tr>
                            <?php
                                }
                            ?>
