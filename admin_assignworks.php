...
$query = "SELECT * FROM request WHERE repair_status = 'Mechanic Assigned'";
...
<div class="container">
            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-8 text-center">WORKS ASSIGNED</h2>
                    </div>
                    <div class="card-body">
    <table class="table table-bordered table-custom">
                            ...
                            <tr>
                                ...
                                <td><?php echo strtoupper($row['mechanic_assign']); ?></td>
