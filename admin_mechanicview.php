...
$query = "SELECT * FROM mechanic_info";
...
<head>
    ...
    <title>Admin-Mechanic View</title>
...
<div class="container">
            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-8 text-center">MECHANIC DETAILS</h2>
                    </div>
                    <div class="card-body">
    <table class="table table-bordered table-custom">
                            ...
                            <tr>
                                ...
                                <td><a href="edit_salary.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit Salary</a>
                              </td>
                            </tr>
                            <?php
                                }
