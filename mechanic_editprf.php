  ...
  <div class="gradient-ba" style="background-color:rgba(0, 0, 0, 0.941); ">
    ...
    <div style="height:auto;width:35%;border-radius:3%;background-color:rgba(0, 0, 0, 0.484);margin-top:3%;margin-bottom:3%">
      ...
      <div style="text-align:center;">
            ...
            <?php
            session_start();
            if (isset($_SESSION['mechanic_name'])) {
                $mechanic_name = $_SESSION['mechanic_name'];}
            if (isset($_SESSION['mechanic_email'])) {
                $mechanic_email = $_SESSION['mechanic_email'];}
            if (isset($_SESSION['mechanic_mobile'])) {
                $mechanic_number = $_SESSION['mechanic_mobile'];}
            if (isset($_SESSION['mechanic_password'])) {
                $mechanic_password = $_SESSION['mechanic_password'];}
            if (isset($_SESSION['mechanic_address'])) {
                $mechanic_address = $_SESSION['mechanic_address'];}
            ...
            <form action="mechanic_update.php" method="post">
              <div style="margin-bottom:7%">
              <img src="img/mech.png"  id="clickable-image" style="height:150px;width:150px;border-radius:50%;cursor:pointer">
              </div>
                       
            <div class="form-floating mb-3" style="margin-top:20px;width:450px;background-color:rgba(244, 240, 240, 0.365);">
                    <input name="name" type="text" class="form-control" id="floatingInput" placeholder="" value="<?php echo $mechanic_name?>" required>
                    <label for="floatingInput">Name</label>
                </div>
        
                <div class="form-floating mb-3" style="width:450px;">
                    <input name="mobile" type="text" class="form-control" id="floatingInput" placeholder="" value="<?php echo $mechanic_number?>" required>
                    <label for="floatingInput">Mobile number</label>
                </div>

                <div class="form-floating mb-3" style="width:450px;">
                    <input name="address" type="text" class="form-control" id="floatingInput" placeholder="" value="<?php echo $mechanic_address?>" required>
                    <label for="floatingInput">Address</label>
                </div>
        
                <div class="form-floating mb-3" style="width:450px;">
                    <input name="email" type="email" class="form-control" id="floatingInput" placeholder="" value="<?php echo $mechanic_email?>" required>
                    <label for="floatingInput">Email address</label>
                </div>
        
                <div class="form-floating" style="width:450px;">
                    <input name="password" type="password" class="form-control" id="floatingPassword" placeholder="" value="<?php echo $mechanic_password?>" required>
